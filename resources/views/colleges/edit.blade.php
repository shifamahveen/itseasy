...
<div class="bg-white shadow rounded p-6">
    ...
    <form action="{{ route('colleges.update', $college->id) }}" method="POST">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-semibold text-gray-800">Edit College</h1>
            <button type="submit" class="block bg-green-500 text-white px-4 py-2 rounded w-fit ms-auto hover:bg-green-600 duration-300">Update</button>
        </div>
        ...
        <div class="grid grid-cols-2 gap-x-8 py-6">
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="name" value="{{ $college->name }}" placeholder="Enter the name of the college" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="address" value="{{ $college->address }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>  
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="code" value="{{ $college->code }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="type" value="{{ $college->type }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="location" value="{{ $college->location }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="rating" value="{{ $college->rating }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="reviews" value="{{ $college->reviews }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="category" value="{{ $college->category }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="contact_person" value="{{ $college->contact_person }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="contact_designation" value="{{ $college->contact_designation }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="contact_phone" value="{{ $college->contact_phone }}" class="w-full p-2 border-2 border-gray-200 rounded" />
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="block w-full col-span-2 text-gray-900 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="text" name="contact_email" value="{{ $college->contact_email }}" class="w-full p-2 border-2 border-gray-200 rounded" />
            </div>      
